...
curl.exe -L -O "https://github.com/erweixin/RaTeX/releases/download/v0.1.9/ratex-cli-v0.1.9-x86_64-pc-windows-msvc.zip"
curl.exe -L -O "https://github.com/erweixin/RaTeX/releases/download/v0.1.9/ratex-cli-v0.1.9-x86_64-unknown-linux-musl.tar.gz"
...
Expand-Archive .\mmdr-x86_64-pc-windows-msvc.zip -DestinationPath .
...
Expand-Archive .\ratex-cli-v0.1.9-x86_64-pc-windows-msvc.zip -DestinationPath .
Move-Item .\ratex-cli-v0.1.9-x86_64-pc-windows-msvc\render-svg.exe .\ratex-svg.exe
Remove-Item .\ratex-cli-v0.1.9-x86_64-pc-windows-msvc.zip
Remove-Item .\ratex-cli-v0.1.9-x86_64-pc-windows-msvc -Recurse -Force

tar -xzf .\ratex-cli-v0.1.9-x86_64-unknown-linux-musl.tar.gz -C .
Move-Item .\ratex-cli-v0.1.9-x86_64-unknown-linux-musl\render-svg .\ratex-svg
Remove-Item .\ratex-cli-v0.1.9-x86_64-unknown-linux-musl.tar.gz
Remove-Item .\ratex-cli-v0.1.9-x86_64-unknown-linux-musl -Recurse -Force
