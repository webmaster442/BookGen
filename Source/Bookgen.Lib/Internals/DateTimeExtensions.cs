...
internal static class DateTimeExtensions
{
    ...
    private const string worpdressTime = "ddd, d MMM yyyy HH:mm:ss"; //Tue, 27 Aug 2019 18:31:33 +0000
    ...
    public static string ToWordpressTime(this DateTime dt)
    {
        return dt.ToString(worpdressTime, new CultureInfo("en-US")) + " +0000";
    }

    public static string ToWordpressPostDate(this DateTime dt)
    {
